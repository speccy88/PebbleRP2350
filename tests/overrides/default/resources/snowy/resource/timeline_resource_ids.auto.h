...
typedef enum {
  ...
  TIMELINE_RESOURCE_NOTIFICATION_BEEPER = 0x80000079,
  TIMELINE_RESOURCE_NOTIFICATION_BLUESKY = 0x8000007a,
  TIMELINE_RESOURCE_NOTIFICATION_DISCORD = 0x8000007b,
  TIMELINE_RESOURCE_NOTIFICATION_DUOLINGO = 0x8000007c,
  TIMELINE_RESOURCE_NOTIFICATION_ELEMENT = 0x8000007d,
  TIMELINE_RESOURCE_NOTIFICATION_GOOGLE_CHAT = 0x8000007e,
  TIMELINE_RESOURCE_NOTIFICATION_GOOGLE_TASKS = 0x8000007f,
  TIMELINE_RESOURCE_NOTIFICATION_HOME_ASSISTANT = 0x80000080,
  TIMELINE_RESOURCE_NOTIFICATION_STEAM = 0x80000081,
  TIMELINE_RESOURCE_NOTIFICATION_TEAMS = 0x80000082,
  TIMELINE_RESOURCE_NOTIFICATION_THREADS = 0x80000083,
  TIMELINE_RESOURCE_NOTIFICATION_UNIFI_PROTECT = 0x80000084,
  TIMELINE_RESOURCE_NOTIFICATION_ZOOM = 0x80000085,
  TIMELINE_RESOURCE_NOTIFICATION_EBAY = 0x80000086,
