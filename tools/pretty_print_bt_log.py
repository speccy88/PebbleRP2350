...
parser = argparse.ArgumentParser(
    description="Pretty print wire-optimized Pebble Bluetooth logs."
)
parser.add_argument(
    "filename", help="File containing a series of packed LogBtMessages."
)
...
def printMessage(message):
    results = message.unpack(
        "uintbe:16, uintbe:16, uintbe:32, uintbe:8, uintbe:8, uintbe:16, hex:128, hex:1024"
    )
