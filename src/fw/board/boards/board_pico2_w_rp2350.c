...
static struct UARTDevice s_dbg_uart = {
    ...
    .tx_gpio = PICO2W_PIN_DEBUG_TX,
    .rx_gpio = PICO2W_PIN_DEBUG_RX,
...
static const Rp2350MemoryLcdConfig s_display = {
    .spi_index = 0,
    .sck_gpio = PICO2W_PIN_LCD_SCK,
    .mosi_gpio = PICO2W_PIN_LCD_MOSI,
    .miso_gpio = PICO2W_PIN_LCD_MISO,
    .lcd_cs_gpio = PICO2W_PIN_LCD_CS,
    .ram_cs_gpio = FRUITJAM_LCD_PIN_UNUSED,
    .disp_gpio = PICO2W_PIN_LCD_DISP,
    .extcomin_gpio = PICO2W_PIN_LCD_EXTCOMIN,
    .inactive_cs_gpio = FRUITJAM_LCD_PIN_UNUSED,
};
...
const BoardConfigButton BOARD_CONFIG_BUTTON = {
    .buttons =
        {
            [BUTTON_ID_BACK] = {"Back", RP2350_GPIO_RESOURCE_EXISTS, PICO2W_PIN_BUTTON_BACK,
                                GPIO_PuPd_UP, false},
            [BUTTON_ID_UP] = {"Up", RP2350_GPIO_RESOURCE_EXISTS, PICO2W_PIN_BUTTON_UP, GPIO_PuPd_UP,
                              false},
            [BUTTON_ID_SELECT] = {"Select", RP2350_GPIO_RESOURCE_EXISTS, PICO2W_PIN_BUTTON_SELECT,
                                  GPIO_PuPd_UP, false},
