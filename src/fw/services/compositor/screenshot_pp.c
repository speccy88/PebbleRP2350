...
#if PLATFORM_SPALDING || PLATFORM_GETAFIX || PLATFORM_SPALDING_GABBRO || PLATFORM_QEMU_GABBRO
...
#elif PLATFORM_GETAFIX || PLATFORM_SPALDING_GABBRO || PLATFORM_QEMU_GABBRO
