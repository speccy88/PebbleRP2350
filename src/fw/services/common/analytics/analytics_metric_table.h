...
#define ANALYTICS_METRIC_TABLE(MARKER, DEVICE, APP, UINT8, UINT16, UINT32, INT8, INT16, INT32) \
  ...
  \
  DEVICE(ANALYTICS_DEVICE_METRIC_APP_ROCKY_LAUNCH_COUNT__DEPRECATED, UINT8) \
  DEVICE(ANALYTICS_DEVICE_METRIC_APP_ROCKY_CRASHED_COUNT__DEPRECATED, UINT8) \
  ...
  APP(ANALYTICS_APP_METRIC_ROCKY_LAUNCH_COUNT__DEPRECATED, UINT8) \
  APP(ANALYTICS_APP_METRIC_ROCKY_CRASHED_COUNT__DEPRECATED, UINT8) \
  \
  ...
  APP(ANALYTICS_APP_METRIC_MEM_ROCKY_HEAP_PEAK__DEPRECATED, UINT32) \
  APP(ANALYTICS_APP_METRIC_MEM_ROCKY_HEAP_WASTE__DEPRECATED, UINT32) \
  APP(ANALYTICS_APP_METRIC_MEM_ROCKY_RECURSIVE_MEMORYPRESSURE_EVENT_COUNT__DEPRECATED, UINT8) \
  \
